...
segment_demand = [x/9.5 for x in segment_demand]
...
# Hydro
hydro_capacity_factor = 10 # http://www.osemosys.org/uploads/1/8/5/0/18504136/hydropower.pdf
...
power_plants = pd.read_csv('/Users/b1017579/Documents/PhD/Projects/11-carbon_optimiser/data/processed/power_plants/scotland_plants.csv', dtype={'Start_date': int})
