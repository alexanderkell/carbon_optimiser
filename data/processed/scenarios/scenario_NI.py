...
segment_demand_diff = [x/30 for x in segment_demand_diff]
...
segment_demand = [x/30 for x in segment_demand]
...
historical_hourly_demand.demand = historical_hourly_demand.demand/30
